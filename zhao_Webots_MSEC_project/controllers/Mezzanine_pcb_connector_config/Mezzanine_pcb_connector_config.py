...
robot = Supervisor()
rospy.init_node("mezzanine_PCB")
rate = rospy.Rate(20)
# get the time step of the current world.
timestep = int(robot.getBasicTimeStep())
OreSat0_MezzaninePCB_3x = Connector("connector_Mezzanine_PCB_to_end_cap")
OreSat0_MezzaninePCB_3x.enablePresence(timestep)
...
shape_node = robot.getFromDef("Mezzanie_appearance")
...
while robot.step(timestep) != -1:
    ...
    #  val = ds.getValue()
    if OreSat0_MezzaninePCB_3x.getPresence() == 1:
            OreSat0_MezzaninePCB_3x.lock()
